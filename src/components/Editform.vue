        ...
        <v-card-text>
         ...
         <v-text-field
          ...
          outlined
            ...
            v-model="address"
            :rules="[
              () => !!address || 'This field is required',addressCheck]"
...
import service from "../service/AddressBookService";
  export default {
    ...
    methods: {
      addressCheck () {
        this.errorMessages = this.address && !this.fname && !this.lname
          ? `Hey! I'm required`
          : ''
        return true
      },
      ...
      submit (event) {
            ...
            service.updateAddressBookData(this.id, data).then((response) => {
